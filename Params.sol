...
contract Params {
    ...
    uint256 public minimumValidatorStaking = 10000000 ether;


    // percent distrubution of Gas Fee earned by validator 100000 = 100%
    uint public stakerPartPercent = 50000;          //50% 
    uint public validatorPartPercent = 50000;        //50%
    uint public burnPartPercent = 0;                //0%
    uint public contractPartPercent = 0;        //50%
    uint public burnStopAmount = 10000000 ether;      // after 10,000,000 coins burn, it will stop burning
